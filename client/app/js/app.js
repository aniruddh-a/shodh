...
(function() {
    ...
    angular
        .module('angle', [
            ...
            'app.mailbox',
            'app.utils',
            //custom modules and controllers
            'app.search'
        ]);
})();
...
//register custom modules and controllers
(function() {
    'use strict';
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('app.search', {
              ...
              resolve: helper.resolveFor('moment', 'localytics.directives', 'ui.bootstrap-slider','spinkit', 'akoenig.deckgrid')
          })
          .state('app.todo', {
              url: '/todo',
              title: 'Todo List',
...
(function() {
    ...
    function Controller($log) {
        ...
        function activate() {
          console.log("inside custom controller");
...
(function() {
    ...
    function SearchController($scope, ChartData, $timeout, $http, $window ) {
      console.log('inside search controller');
        ...
        angular.copy(filterDefaultOptions, $scope.filter);
